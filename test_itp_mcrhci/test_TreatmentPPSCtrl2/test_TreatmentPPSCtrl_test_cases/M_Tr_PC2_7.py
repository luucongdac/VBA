...
class SET_FILL_TEXTBOX_SETPOINT_POSITION_CM_X_VALID(SETUP_INPUT_TEXTBOX_BY_NAME):
    textbox_name = "mcr_treatment_pps_ctrl2:pcu4_latsetpoint"
    content = "10.0"
    extension_key = '\n'
...
class __M_Tr_PC2_7__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
        name = "Validate action of textbox Setpoint Position (cm) of X in Treatment PPS Ctrl2 screen"
        info_exchange = [
                        ]
