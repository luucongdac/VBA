...
class VALIDATE_TR1_TOLERANCE_CHECK_VIEW_IS_DISPLAYED(SETUP_VIEW_DISPLAY_STATUS_CHECK):
    name = "Confirm that tr1_tolerance_check.v is displayed"
    view_name = "tr1_tolerance_check"
    expected_result = "1"
...
class __M_PL_37__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
        name = 'Simulate & Validate "TR1 Tolerance Check button(B5)" - Show view tr1_tolerance_check.v'
        info_exchange = [
                        ]
        ...
        self.setup =    [
                        ...
                        VALIDATE_TR1_TOLERANCE_CHECK_VIEW_IS_DISPLAYED,
