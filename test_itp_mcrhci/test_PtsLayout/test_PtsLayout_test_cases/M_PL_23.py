...
Testing procedure:
 ...
 (2) Click on Edit TR1 Nozzle button
* Confirm after step (2)
  + Confirm file nozzle1_parameters is opened for editing

Confirm file nozzle1_parameters is opened for editing
===============> manual check on the HP-UX screen
'''    
class __M_PL_23__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
        name = 'Simulate & Validate "Edit TR1 Nozzle Button(B16), File nozzle1_parameters.txt in ./hp/log/system/ open for editing'
        info_exchange = [
                        ]
