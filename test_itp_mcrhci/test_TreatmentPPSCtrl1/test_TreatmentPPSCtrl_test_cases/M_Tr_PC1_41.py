...
class SET_VARIABLE_MOTION_MODE_NUMBER_1(SETUP_SET_VARIABLE):
    var_name = "tr1_pcu_pps_motion_mode"
    value    = 1.0
...
class VALIDATE_MOTION_MODE_NUMBER_1(SETUP_VALIDATE_OBJECT_INFO):
    object_name = "mcr_treatment_pps_ctrl1:pcu4_motionmode"
    expected_value = 1.0
...
class __M_Tr_PC1_41__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
        name = "Validate label number of Motion Mode in Treatment PPS Ctrl1 screen"
        info_exchange = [
                        ]
