...
class VALIDATE_CHECKMARK_SAFETY_INTERLOCK_OK(SETUP_VALIDATE_OBJECT_INFO):
    object_name = "mcr_treatment_pps_ctrl1:pcu4_safetyintlk"
...
class __M_Tr_PC1_19__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
        name = "Validate checkmark of Safety Interlock (SCU) in Treatment PPS Ctrl1 screen"
        info_exchange = [
                        ]
