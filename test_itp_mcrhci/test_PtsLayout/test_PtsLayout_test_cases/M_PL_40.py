...
class VALIDATE_TR2_TOLERANCE_CHECK_PBS_VIEW_IS_DISPLAYED(SETUP_VIEW_DISPLAY_STATUS_CHECK):
    name = "Confirm that tr2_tolerance_check_pbs.v is displayed"
    view_name = "tr2_tolerance_check_pbs"
    expected_result = "1"
...
class __M_PL_40__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
        name = 'Simulate & Validate "TR2 Tolerance Check button(B9)" - Show view tr2_tolerance_check_pbs.v'
        info_exchange = [
                        ]
        ...
        self.setup =    [
                        ...
                        VALIDATE_TR2_TOLERANCE_CHECK_PBS_VIEW_IS_DISPLAYED,
