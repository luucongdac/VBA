...
class CHANGE_PERMISSION_000_TO_TR2_NOZZLE_FILE_AND_RECHECK(SETUP_CHANGE_PERMISSION_AND_RECHECK_FILE):
...
class CHANGE_PERMISSION_777_TO_TR2_NOZZLE_FILE_AND_RECHECK(SETUP_CHANGE_PERMISSION_AND_RECHECK_FILE):
...
'''    
class __M_PL_31__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
        name = 'Simulate & Validate "Edit TR2 Nozzle Button(B17),nozzle2_parameters.txt file is busy in /hp/log/system/ for editing'
        info_exchange = [
                        ]
        ...
        self.setup =    [
                        ...
                        CHANGE_PERMISSION_000_TO_TR2_NOZZLE_FILE_AND_RECHECK,
                        THRIVER_WAIT_1_SECONDS,
                        CLICK_EDIT_TR2_NOZZLE_BUTTON,
                        THRIVER_WAIT_1_SECONDS,
                        CHANGE_PERMISSION_777_TO_TR2_NOZZLE_FILE_AND_RECHECK,
