...
class SET_FILL_TEXTBOX_SETPOINT_POSITION_CM_Y_VALID(SETUP_INPUT_TEXTBOX_BY_NAME):
    textbox_name = "mcr_treatment_pps_ctrl1:pcu4_longsetpoint"
    content  = "10.0"
    extension_key = '\n'
...
class __M_Tr_PC1_9__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
        name = "Validate action of textbox Setpoint Position (cm) of Y in Treatment PPS Ctrl1 screen"
        info_exchange = [
                        ]
