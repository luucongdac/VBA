...
class VALIDATE_SHORT_INVISIBLE(SETUP_VALIDATE_OBJECT_INFO):
    object_name = "mcr_treatment_pps_ctrl1:pcu4_couchshort"
    expected_value = "0"
...
class __M_Tr_PC1_39__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
        name = "Validate visibility of label Short in Treatment PPS Ctrl1 screen"
        info_exchange = [
                        ]
