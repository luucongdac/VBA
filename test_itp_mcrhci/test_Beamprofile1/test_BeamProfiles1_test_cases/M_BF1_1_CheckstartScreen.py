...
from procedures.thriver.test_itp_mcrhci.SETUP.setup_mcrhci_treatment_beam_profiles_1_screen import SETUP_CLICK_BEAM_PROFILES_1
from procedures.thriver.test_itp_mcrhci.SETUP.setup_mcrhci_treatment_beam_profiles_1_screen import SETUP_VALIDATE_OPEN_BEAM_PROFILES_1
...
class OPEN_BEAM_PROFILES_1_SCREEN(SETUP_CLICK_BEAM_PROFILES_1): pass
class VALIDATE_OPEN_BEAM_PROFILES_1(SETUP_VALIDATE_OPEN_BEAM_PROFILES_1): pass

class __M_BF1_1__(ClinicalIntegrationTestProcedure):
	def __init__(self, test):
		...
		self.setup =    [  
						...
						THRIVER_WAIT_10_SECONDS,
						OPEN_BEAM_PROFILES_1_SCREEN,
						VALIDATE_OPEN_BEAM_PROFILES_1,
						]
		self.teardown_path = []