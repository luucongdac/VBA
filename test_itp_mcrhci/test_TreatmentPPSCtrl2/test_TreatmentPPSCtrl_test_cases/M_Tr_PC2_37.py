...
class SET_VARIABLE_SPEED_LEVEL_LOW_SPEED(SETUP_SET_VARIABLE):
    var_name = "tr2_pcu_sw_high_speed_level"
    value    = False
...
class VALIDATE_SPEED_LEVEL_LOW_SPEED(SETUP_VALIDATE_OBJECT_INFO):
    object_name = "mcr_treatment_pps_ctrl2:pcu4_speedlevel"
    expected_value = "0"
...
class __M_Tr_PC2_37__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
        name = "Validate value of label Speed Level in Treatment PPS Ctrl2 screen"
        info_exchange = [
                        ]
