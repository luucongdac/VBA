...
class VALIDATE_LOADCELL_FORCE_Z_VALUE_IN_LOADCELL_GRAPH_2(SETUP_VALIDATE_OBJECT_INFO):
    object_name = "pcu_room2_lc_graph"
    expected_value = 123.21
    info_type = "TMMI_MCR_OBJECT_GET_VALUE"

class __M_T_LG2_4__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
        name = "Validate that Loadcell Force Z is shown in Loadcell Graph 2 screen"
        info_exchange = [
                        ]
        ...
        self.setup =    [  
                        ...
                        VALIDATE_LOADCELL_FORCE_Z_VALUE_IN_LOADCELL_GRAPH_2,
