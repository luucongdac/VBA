...
class VALIDATE_DEFAULT_PPS_CTRL1(SETUP_VALIDATE_DEFAULT_PPS_CTRL1): pass

class __M_Tr_PC1_1__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
        name = "Start MCR GUI and navigate to PPS Ctrl 1 Screen"
        info_exchange = [
                        ]
