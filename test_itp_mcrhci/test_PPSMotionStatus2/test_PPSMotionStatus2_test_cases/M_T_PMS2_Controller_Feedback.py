...
class SET_MOTOR_ACTIVATED_Z_CHECK_OK(SETUP_SET_VARIABLE):
    var_name = "tr2_pcu_pps_zmotor_activated"
    value    = True
...
class SET_POSITIVE_EOT_NOT_REACHED_Z_CHECK_OK(SETUP_SET_VARIABLE):
    var_name = "tr2_pcu_pps_zmotor_positive_endlimit"
    value    = False
...
class SET_NEGATIVE_EOT_NOT_REACHED_Z_CHECK_OK(SETUP_SET_VARIABLE):
    var_name = "tr2_pcu_pps_zmotor_negative_endlimit"
    value    = False
...
class VALIDATE_MOTOR_ACTIVATED_X_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_xactivated"
...
class VALIDATE_VELOCITY_ZERO_NO_REQUESTED_X_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_xv0"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_VELOCITY_ZERO_NO_REQUESTED_Y_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_yv0"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_VELOCITY_ZERO_NO_REQUESTED_Z_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_zv0"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_VELOCITY_ZERO_NO_REQUESTED_RT_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_rotv0"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_VELOCITY_ZERO_NO_REQUESTED_PCH_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_pitchv0"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_VELOCITY_ZERO_NO_REQUESTED_ROLL_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_rollv0"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_NO_ABORT_DECELERATION_RT_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_rotabortdec"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_NO_ABORT_DECELERATION_PCH_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_pitchabortdec"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_NO_ABORT_DECELERATION_ROLL_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_rollabortdec"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_NO_FATAL_FOLLOWING_ERROR_X_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_xfatalerror"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_NO_FATAL_FOLLOWING_ERROR_Y_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_yfatalerror"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_NO_FATAL_FOLLOWING_ERROR_Z_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_zfatalerror"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_NO_FATAL_FOLLOWING_ERROR_RT_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_rotfatalerror"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_NO_FATAL_FOLLOWING_ERROR_PCH_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_pitchfatalerror"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_NO_FATAL_FOLLOWING_ERROR_ROLL_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_rollfatalerror"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_NO_FATAL_FOLLOWING_ERROR_GANTRY_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_gantryfatalerror"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_NO_WARNING_FOLLOWING_ERROR_X_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_xwarningerror"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_NO_WARNING_FOLLOWING_ERROR_Y_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_ywarningerror"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_NO_WARNING_FOLLOWING_ERROR_Z_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_zwarningerror"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_NO_WARNING_FOLLOWING_ERROR_RT_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_rotwarningerror"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_NO_WARNING_FOLLOWING_ERROR_PCH_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_pitchwarningerror"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_NO_WARNING_FOLLOWING_ERROR_ROLL_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_rollwarningerror"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_STOP_ON_POSITION_LIMIT_X_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_xstoppl"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_STOP_ON_POSITION_LIMIT_Y_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_ystoppl"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_STOP_ON_POSITION_LIMIT_Z_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_zstoppl"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_STOP_ON_POSITION_LIMIT_RT_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_rotstoppl"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_STOP_ON_POSITION_LIMIT_PCH_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_pitchstoppl"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_STOP_ON_POSITION_LIMIT_ROLL_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_rollstoppl"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_STOP_ON_POSITION_LIMIT_GANTRY_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_gantrystoppl"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_POSITIVE_EOT_NOT_REACHED_X_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_xpel"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_POSITIVE_EOT_NOT_REACHED_Y_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_ypel"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_POSITIVE_EOT_NOT_REACHED_Z_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_zpel"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_POSITIVE_EOT_NOT_REACHED_RT_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_rotpel"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_POSITIVE_EOT_NOT_REACHED_PCH_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_pitchpel"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_POSITIVE_EOT_NOT_REACHED_ROLL_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_rollpel"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_POSITIVE_EOT_NOT_REACHED_GANTRY_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_gantrypel"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_NEGATIVE_EOT_NOT_REACHED_X_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_xnel"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_NEGATIVE_EOT_NOT_REACHED_Y_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_ynel"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_NEGATIVE_EOT_NOT_REACHED_Z_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_znel"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_NEGATIVE_EOT_NOT_REACHED_RT_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_rotnel"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_NEGATIVE_EOT_NOT_REACHED_PCH_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_pitchnel"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_NEGATIVE_EOT_NOT_REACHED_ROLL_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_rollnel"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class VALIDATE_NEGATIVE_EOT_NOT_REACHED_GANTRY_CHECK_OK(SETUP_VALIDATE_OBJECT_INFO):
    ...
    object_name    = "mcr_treatment_pps_motion_status2:pcu5_gantrynel"
    info_type      = "TMMI_MCR_OBJECT_GET_SUBOBJECT_NAME"
    expected_value = "iba_check_ok.sd"
...
class __M_T_PMS2_2__(ClinicalIntegrationTestProcedure):
...
class __M_T_PMS2_3__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_4__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_5__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_6__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_7__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_8__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_9__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_10__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_11__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_12__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_13__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_14__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_15__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_16__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_17__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_18__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_19__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_20__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_21__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_22__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_23__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_24__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_25__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_26__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_27__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_28__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_29__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_30__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_31__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_32__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_33__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_34__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_35__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_36__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_37__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_38__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_39__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_40__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_41__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_42__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_43__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_44__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_45__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_46__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_47__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_48__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_49__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_50__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_51__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_52__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_53__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_54__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_55__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_56__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_57__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_58__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_59__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_60__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_61__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_62__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_63__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_64__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_65__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_66__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_67__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_68__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_69__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_70__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_71__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_72__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_73__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_74__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_75__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_76__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_77__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_78__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_79__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_80__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_81__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_82__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_83__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_84__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
...
class __M_T_PMS2_85__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
