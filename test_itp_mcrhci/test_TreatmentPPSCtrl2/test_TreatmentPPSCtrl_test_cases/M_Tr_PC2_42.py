...
class VALIDATE_SAFETY_INTERLOCK_BLACK(SETUP_VALIDATE_OBJECT_INFO):
    object_name = "mcr_treatment_pps_ctrl2:pcu4_safetyintlklbl"
...
class __M_Tr_PC2_42__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
        name = "Validate color of label Safety Interlock in Treatment PPS Ctrl2 screen"
        info_exchange = [
                        ]
