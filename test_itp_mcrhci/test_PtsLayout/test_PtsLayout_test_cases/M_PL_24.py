...
class DELETE_TR1_NOZZLE_FILE(SETUP_DELETE_FILE):
    name = "Delete nozzle1_parameters.txt file in /hp/log/system/"
...
Testing procedure:
 ...
 (2) delete nozzle1_parameters.txt file in /hp/log/system/
...
'''    
class __M_PL_24__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
        name = 'Simulate & Validate "Edit TR1 Nozzle Button(B16), nozzle1_parameters.txt file not exist in /hp/log/system/ for editing'
        info_exchange = [
                        ]
