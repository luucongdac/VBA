...
class VALIDATE_LONG_INVISIBLE(SETUP_VALIDATE_OBJECT_INFO):
    object_name = "mcr_treatment_pps_ctrl2:pcu4_couchlong"
    expected_value = "0"
...
class __M_Tr_PC2_40__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
        name = "Validate visibility of label Long in Treatment PPS Ctrl2 screen"
        info_exchange = [
                        ]
