...
class SET_VARIABLE_LABEL_SETPOINT_POSITION_DEG_ROLL_VALUE(SETUP_SET_VARIABLE):
    var_name = "tr1_pcu_goto_pps_roll_degtarget"
    value    = 2.0

class VALIDATE_LABEL_SETPOINT_POSITION_DEG_ROLL_VISIBLE(SETUP_VALIDATE_OBJECT_INFO):
    object_name = "mcr_treatment_pps_ctrl1:pcu4_rolltxt"
    expected_value = "1"
    info_type = "TMMI_MCR_IS_VISIBLE"

class VALIDATE_RECTANGLE_SETPOINT_POSITION_DEG_ROLL_VISIBLE(SETUP_VALIDATE_OBJECT_INFO):
    object_name = "mcr_treatment_pps_ctrl1:pps_ctrl1_6"
    expected_value = "1"
    info_type = "TMMI_MCR_IS_VISIBLE"

class SET_FILL_TEXTBOX_SETPOINT_POSITION_DEG_ROLL_VALID(SETUP_INPUT_TEXTBOX_BY_NAME):
    textbox_name = "mcr_treatment_pps_ctrl1:pcu4_rollsetpoint"
    content = "1.0"
    extension_key = '\n'
...
class SET_FILL_TEXTBOX_SETPOINT_POSITION_DEG_ROLL_OVERMAX(SETUP_INPUT_TEXTBOX_BY_NAME):
    textbox_name = "mcr_treatment_pps_ctrl1:pcu4_rollsetpoint"
    content = "4.0"
    extension_key = '\n'

class VALIDATE_TEXTBOX_SETPOINT_POSITION_DEG_ROLL_OVERMAX(SETUP_VALIDATE_VALUE_OF_OBJECT_SLOT):
    object_name = "pcu4_rollsetpoint"
    slot_name = "roll_setpoint_text"
    expected_value = "> Max"

class SET_FILL_TEXTBOX_SETPOINT_POSITION_DEG_ROLL_OVERMIN(SETUP_INPUT_TEXTBOX_BY_NAME):
    textbox_name = "mcr_treatment_pps_ctrl1:pcu4_rollsetpoint"
    content = "-4.0"
    extension_key = '\n'

class VALIDATE_TEXTBOX_SETPOINT_POSITION_DEG_ROLL_OVERMIN(SETUP_VALIDATE_VALUE_OF_OBJECT_SLOT):
    object_name = "pcu4_rollsetpoint"
    slot_name = "roll_setpoint_text"
    expected_value = "< Min"

class SET_FILL_TEXTBOX_SETPOINT_POSITION_DEG_ROLL_ERROR(SETUP_INPUT_TEXTBOX_BY_NAME):
    textbox_name = "mcr_treatment_pps_ctrl1:pcu4_rollsetpoint"
    content = "abc"
    extension_key = '\n'

class VALIDATE_TEXTBOX_SETPOINT_POSITION_DEG_ROLL_ERROR(SETUP_VALIDATE_VALUE_OF_OBJECT_SLOT):
    object_name = "pcu4_rollsetpoint"
    slot_name = "roll_setpoint_text"
...
class __M_Tr_PC1_17__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
        ...
        self.setup =    [  
                        ...
                        SET_FILL_TEXTBOX_SETPOINT_POSITION_DEG_ROLL_OVERMAX,
                        ...
                        VALIDATE_TEXTBOX_SETPOINT_POSITION_DEG_ROLL_OVERMAX,
                        SET_FILL_TEXTBOX_SETPOINT_POSITION_DEG_ROLL_OVERMIN,
                        THRIVER_WAIT_3_SECONDS,
                        VALIDATE_LABEL_SETPOINT_POSITION_DEG_ROLL_INVISIBLE,
                        VALIDATE_RECTANGLE_SETPOINT_POSITION_DEG_ROLL_INVISIBLE,
                        VALIDATE_TEXTBOX_SETPOINT_POSITION_DEG_ROLL_OVERMIN,
                        SET_FILL_TEXTBOX_SETPOINT_POSITION_DEG_ROLL_ERROR,
                        THRIVER_WAIT_3_SECONDS,
                        VALIDATE_LABEL_SETPOINT_POSITION_DEG_ROLL_INVISIBLE,
                        VALIDATE_RECTANGLE_SETPOINT_POSITION_DEG_ROLL_INVISIBLE,
                        VALIDATE_TEXTBOX_SETPOINT_POSITION_DEG_ROLL_ERROR,
                        SET_FILL_TEXTBOX_SETPOINT_POSITION_DEG_ROLL_VALID,
                        THRIVER_WAIT_3_SECONDS,
                        VALIDATE_LABEL_SETPOINT_POSITION_DEG_ROLL_VISIBLE,
                        VALIDATE_RECTANGLE_SETPOINT_POSITION_DEG_ROLL_VISIBLE,
