...
class VALIDATE_LOADCELL_TORQUE_Y_VALUE_IN_LOADCELL_GRAPH_1(SETUP_VALIDATE_OBJECT_INFO):
    object_name = "pcu_room1_lc_graph"
    expected_value = 123.21
    info_type = "TMMI_MCR_OBJECT_GET_VALUE"

class __M_T_LG1_8__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
        name = "Validate that Loadcell Torque Y is shown in Loadcell Graph 1 screen"
        info_exchange = [
                        ]
        ...
        self.setup =    [  
                        ...
                        VALIDATE_LOADCELL_TORQUE_Y_VALUE_IN_LOADCELL_GRAPH_1,
