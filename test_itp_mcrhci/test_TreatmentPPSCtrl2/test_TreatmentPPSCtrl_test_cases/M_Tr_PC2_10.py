...
class SET_CLICK_LABEL_SETPOINT_POSITION_CM_Z(SETUP_CLICK_BUTTON_BY_NAME):
    button_name = "mcr_treatment_pps_ctrl2:pcu4_verttxt"
...
class __M_Tr_PC2_10__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
        name = "Validate value, visibility of label Setpoint Position (cm) of Z in Treatment PPS Ctrl2 screen"
        info_exchange = [
                        ]
