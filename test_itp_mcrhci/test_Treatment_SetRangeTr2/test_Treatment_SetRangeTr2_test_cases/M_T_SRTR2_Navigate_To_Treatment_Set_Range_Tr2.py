...
class VALIDATE_OPEN_TREATMENT_SET_RANGE_TR2(SETUP_VALIDATE_OPEN_TREATMENT_SET_RANGE_TR2): pass
class SETUP_CLICK_SET_RANGE_TR2_BTN(SETUP_CLICK_BUTTON_BY_POSITION):
    name = "Click Set range tr2 in Treatment Mainmenu according to its position"
    button_pos_x = 100
    button_pos_y = 415

class __M_T_SRTR2_1__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
        name = 'Simulate & Validate "Login and select session" - MCR start GUI and Login to Treatment Set Range Tr2'
        info_exchange = [
                        ]
        ...
        self.setup =    [  
                        ...
                        SETUP_CLICK_SET_RANGE_TR2_BTN,
                        THRIVER_WAIT_20_SECONDS,
                        VALIDATE_OPEN_TREATMENT_SET_RANGE_TR2,
                        ]
        self.teardown_path = []