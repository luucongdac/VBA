...
class SET_VARIABLE_BLIP_PROXIMITY_DETECTED_OK(SETUP_SET_VARIABLE):
    var_name = "tr1_pcu_proxyctrl_global_status"
    value    = True

class VALIDATE_BLIP_PROXIMITY_DETECTED_OK(SETUP_VALIDATE_OBJECT_INFO):
    object_name = "mcr_treatment_pps_ctrl1:pcu4_proxdetected"
...
class __M_Tr_PC1_36__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
        name = "Validate blip of Proximity Detected in Treatment PPS Ctrl1 screen"
        info_exchange = [
                        ]
