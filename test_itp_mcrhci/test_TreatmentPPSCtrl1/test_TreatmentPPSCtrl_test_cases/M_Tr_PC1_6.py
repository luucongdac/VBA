...
class SET_CLICK_LABEL_SETPOINT_POSITION_CM_X(SETUP_CLICK_BUTTON_BY_NAME):
    button_name = "mcr_treatment_pps_ctrl1:pcu4_lattxt"
...
class __M_Tr_PC1_6__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
        name = "Validate value, visibility of label Setpoint Position (cm) of X in Treatment PPS Ctrl1 screen"
        info_exchange = [
                        ]
