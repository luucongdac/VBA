...
class SET_VALIDATE_NUMERIC_VAR_FOREGROUND_COLOR_0(SETUP_SET_VALIDATE_NUMERIC_VAR_FOREGROUND_COLOR):
    variable_name = "tr3_accept_led"
    variable_set = random.uniform(0,0.5)
    object_name = "mcr1_allocatetr3a_led"
...
class __M_T_BC_14__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
        name = 'Simulate and Validate Led status of "Accept" button.'
        info_exchange = [
                        ]
