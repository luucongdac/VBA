...
class SET_VARIABLE_RAW_FORCE_Z(SETUP_SET_VARIABLE):
    var_name = "tr1_pcu_loadcell_forcey_raw"
    value    = 10.0

class SET_VARIABLE_RAW_OFFSET_FORCE_Z(SETUP_SET_VARIABLE):
    var_name = "tr1_pcu_loadcell_forcey_raw_offset"
    value    = 10.0
...
class SET_VARIABLE_RAW_TORQUE_Z(SETUP_SET_VARIABLE):
    var_name = "tr1_pcu_loadcell_torquey_raw"
    value    = 10.0

class SET_VARIABLE_RAW_OFFSET_TORQUE_Z(SETUP_SET_VARIABLE):
    var_name = "tr1_pcu_loadcell_torquey_raw_offset"
    value    = 10.0
...
class VALIDATE_RAW_FORCE_Z(SETUP_VALIDATE_OBJECT_INFO):
    object_name = "mcr_treatment_pps_ctrl1:pcu4_zforceraw"
    expected_value = 10.0
    info_type = "TMMI_MCR_OBJECT_GET_VALUE"

class VALIDATE_RAW_OFFSET_FORCE_Z(SETUP_VALIDATE_OBJECT_INFO):
    object_name = "mcr_treatment_pps_ctrl1:pcu4_zforcerawoffset"
    expected_value = 10.0
    info_type = "TMMI_MCR_OBJECT_GET_VALUE"

class VALIDATE_ENG_FORCE_Z(SETUP_VALIDATE_OBJECT_INFO):
    object_name = "mcr_treatment_pps_ctrl1:pcu4_zforceeng"
    expected_value = 10.0
    info_type = "TMMI_MCR_OBJECT_GET_VALUE"

class VALIDATE_RAW_TORQUE_Z(SETUP_VALIDATE_OBJECT_INFO):
    object_name = "mcr_treatment_pps_ctrl1:pcu4_ztorqueraw"
    expected_value = 10.0
    info_type = "TMMI_MCR_OBJECT_GET_VALUE"

class VALIDATE_RAW_OFFSET_TORQUE_Z(SETUP_VALIDATE_OBJECT_INFO):
    object_name = "mcr_treatment_pps_ctrl1:pcu4_ztorquerawoffset"
    expected_value = 10.0
    info_type = "TMMI_MCR_OBJECT_GET_VALUE"

class VALIDATE_ENG_TORQUE_Z(SETUP_VALIDATE_OBJECT_INFO):
    object_name = "mcr_treatment_pps_ctrl1:pcu4_ztorqueeng"
    expected_value = 10.0
    info_type = "TMMI_MCR_OBJECT_GET_VALUE"

class __M_Tr_PC1_34__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
        name = "Validate value of label Force and Torque of Z in Treatment PPS Ctrl1 screen"
        info_exchange = [
                        ]
