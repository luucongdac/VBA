...
class __M_PL_9__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
        name = 'Simulate & Validate "BTS3ABC image(A8) in Service session" - Show view MCR_Service_BTS3ABC_Layout view & Show menu MCR_Service_BTS3ABCMenu on left menu panel'
        info_exchange = [
                        ]
