...
class __M_PL_6__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
        name = 'Simulate & Validate "GTS2 image(A5) in Service session" - Show view MCR_Service_GTS2_Layout view & Show menu MCR_Service_BTS2Menu on left menu panel'
        info_exchange = [
                        ]
