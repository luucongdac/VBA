...
class SET_VARIABLE_CHECKMARK_PPCA_ENABLED_OK(SETUP_SET_VARIABLE):
    var_name = "tr2_pcu_ppca_enable_correction"
    value    = True

class VALIDATE_CHECKMARK_PPCA_ENABLED_OK(SETUP_VALIDATE_OBJECT_INFO):
    object_name = "mcr_treatment_pps_ctrl2:pcu4_xnel_1"
...
class __M_Tr_PC2_18__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
        name = "Validate checkmark of PPCA Enabled in Treatment PPS Ctrl2 screen"
        info_exchange = [
                        ]
