...
class __M_PL_52__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
        name = 'Simulate & Validate "GTS1 image (A3)" in Treatment session - Show view MCR_Service_GTS1_Layout view & Show menu MCR_Treatment_BTS1Menu on left menu panel'
        info_exchange = [
                        ]
