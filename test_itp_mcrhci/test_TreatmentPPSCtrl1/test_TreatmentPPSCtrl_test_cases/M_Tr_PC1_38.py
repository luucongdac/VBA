...
class SET_VARIABLE_NO_EXTENSION_INVISIBLE(SETUP_SET_VARIABLE):
    var_name = "tr1_pcu_couch_no_extension"
    value    = False
...
class VALIDATE_NO_EXTENSION_INVISIBLE(SETUP_VALIDATE_OBJECT_INFO):
    object_name = "mcr_treatment_pps_ctrl1:pcu4_couchext"
    expected_value = "0"
...
class __M_Tr_PC1_38__(ClinicalIntegrationTestProcedure):
    def __init__(self, test):
        name = "Validate visibility of label No Extension in Treatment PPS Ctrl1 screen"
        info_exchange = [
                        ]
